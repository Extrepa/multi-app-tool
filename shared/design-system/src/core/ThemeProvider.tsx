...
import { ThemeMode, EffectMode, NeonColor } from './types';
...
export function useErrlThemeContext() {
  const context = useContext(ThemeContext);
  if (context === undefined) {
    throw new Error('useErrlThemeContext must be used within a ThemeProvider');
  }
  return context;
}
